        ...
        {data.map((fruit, index) => (
          <li key={index}>
            <button
              ...
              onClick={() => handleShowBrief(index, fruit)}
            >
              <div className="max-h-[7.5vw] overflow-hidden rounded-[0.5vw]">
                <Image
                  src={
                    "https://media.istockphoto.com/id/1029797404/photo/cheenavala-in-kochi.jpg?s=612x612&w=0&k=20&c=njgmKK-rdoZS0BWz0MkZuWJHzpE0qzwKuqtpsBz-BB0="
                  }
                  width={5}
                  height={5}
              ...
              <div className="flex flex-col min-h-[7.5vw] flex-1 mx-[1vw]">
                <div className="text-start flex-1">
                  <p className="text-[1.5vw] leading-[1.5vw]">
                    {fruit.data.address.city}, {fruit.data.address.county},{" "}
                    {fruit.data.address.state_district},{" "}
                    {fruit.data.address.country}, {fruit.data.address.postcode}
                  </p>
                  <p>54</p>
                </div>
